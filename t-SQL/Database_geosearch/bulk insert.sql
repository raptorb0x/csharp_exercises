truncate table dbo.GeoCity --очищаем основную таблицу
...
bulk insert #temp From 'C:\test_.txt'   -- грузим данные из файла
with (FIELDTERMINATOR = ',', ROWTERMINATOR = '\n'); -- разделеитель полей запятая, разделитель строк - перенос строки

Insert into dbo.GeoCity (Contry,City,AccentCity,Region,Pupulation,Lat,Long) --вставляем в основную таблицу
...
select count(id) from dbo.GeoCity -- проверяем наличие записей в основной таблице, считая количество первичных ключей