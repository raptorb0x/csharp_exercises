...
{
    public class Spr_Vid_RabViewModel : DocumentViewModel
    {
        #region Private fields
        private List<Spr_Vid_Rab> _data;
        ...
        #region Spr_Vid_Rab binding fields
        private Spr_Vid_Rab _editingElem;

        public Spr_Vid_Rab EditingElem
        {
        ...
        #region Constructors
        public Spr_Vid_RabViewModel(string docName, MainWindowViewModel mainModelView)
        ...
        public List<Spr_Vid_Rab> Data
        {
            get
            {
                if (_data == null)
                    _data = new List<Spr_Vid_Rab>();
                return _data;
            }
            private set
            {
        ...
        public void AddApprove()
        {
            ...
            switch (_opType)
            {
                case OperationType.Add:
                    Spr_Vid_Rab addElem = EditingElem.Copy() as Spr_Vid_Rab;
                    DataBase.DataBase.AddSpr_Vid_Rab(addElem);
                    break;
                case OperationType.Edit:
                    Spr_Vid_Rab editElem = EditingElem.Copy() as Spr_Vid_Rab;
                    DataBase.DataBase.EditSpr_Vid_Rab(editElem);
                    break;
            }
        ...
        public override void Refresh()
        {
            ...
            Data = new List<Spr_Vid_Rab>(DataBase.DataBase.GetSpr_Vid_Rab());
        }
        ...
        public override void Delete()
        {
            ...
            {
                Spr_Vid_Rab item = collectionView.CurrentItem as Spr_Vid_Rab;
                if (item != null)
                    DataBase.DataBase.DeleteSpr_Vid_Rab(item);
            }
            Refresh();
        }
        ...
        public override void Edit()
        {
            ...
            if (collectionView != null)
            {
                ...
                if (item != null)
                {
                    ...
                    EditingElem = item.Copy() as Spr_Vid_Rab;
