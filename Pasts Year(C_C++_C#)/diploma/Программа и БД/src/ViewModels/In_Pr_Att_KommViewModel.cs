...
{
    public class In_Pr_Att_KommViewModel : DocumentViewModel
    {
        #region Private fields
        private List<In_Pr_Att_Komm> _data;
        ...
        #region In_Pr_Att_Komm binding fields
        private In_Pr_Att_Komm _editingElem;

        public In_Pr_Att_Komm EditingElem
        {
        ...
        #region Constructors
        public In_Pr_Att_KommViewModel(string docName, MainWindowViewModel mainModelView)
        ...
        public List<In_Pr_Att_Komm> Data
        {
            get
            {
                if (_data == null)
                    _data = new List<In_Pr_Att_Komm>();
                return _data;
            }
            private set
            {
        ...
        public void AddApprove()
        {
            switch (_opType)
            {
                case OperationType.Add:
                    In_Pr_Att_Komm addElem = EditingElem.Copy() as In_Pr_Att_Komm; 
                    DataBase.DataBase.AddIn_Pr_Att_Komm(addElem);
                    break;
                case OperationType.Edit:
                    In_Pr_Att_Komm editElem = EditingElem.Copy() as In_Pr_Att_Komm;
                    DataBase.DataBase.EditIn_Pr_Att_Komm(editElem);
                    break;
            }
        ...
        {
            double r;
            return EditingElem == null ? false : double.TryParse(EditingElem.SummBall, out r) && double.TryParse(EditingElem.ProhodBall, out r) && EditingElem.Date != null;
        }
        ...
        public override void Refresh()
        {
            ...
            Data = new List<In_Pr_Att_Komm>(DataBase.DataBase.GetIn_Pr_Att_Komm());
        }
        ...
        public override void Delete()
        {
            ...
            {
                In_Pr_Att_Komm item = collectionView.CurrentItem as In_Pr_Att_Komm;
                if (item != null)
                    DataBase.DataBase.DeleteIn_Pr_Att_Komm(item);
            }
            Refresh();
        }
        ...
        {
            EditingElem = new In_Pr_Att_Komm();
        ...
        public override void Edit()
        {
            ...
            if (collectionView != null)
            {
                ...
                {
                    Sotrs = DataBase.DataBase.GetSpr_Sotr();
                    EditingElem = item.Copy() as In_Pr_Att_Komm;
