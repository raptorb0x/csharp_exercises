...
{
    public class In_Prikaz_PerevodViewModel : DocumentViewModel
    {
        #region Private fields
        private List<In_Prikaz_Perevod> _data;
        ...
        #region In_Prikaz_Perevod binding fields
        private In_Prikaz_Perevod _editingElem;

        public In_Prikaz_Perevod EditingElem
        {
        ...
        #region Constructors
        public In_Prikaz_PerevodViewModel(string docName, MainWindowViewModel mainModelView)
        ...
        public List<In_Prikaz_Perevod> Data
        {
            get
            {
                if (_data == null)
                    _data = new List<In_Prikaz_Perevod>();
                return _data;
            }
            private set
            {
        ...
        public void AddApprove()
        {
            switch (_opType)
            {
                case OperationType.Add:
                    In_Prikaz_Perevod addElem = EditingElem.Copy() as In_Prikaz_Perevod; 
                    DataBase.DataBase.AddIn_Prikaz_Perevod(addElem);
                    break;
                case OperationType.Edit:
                    In_Prikaz_Perevod editElem = EditingElem.Copy() as In_Prikaz_Perevod;
                    DataBase.DataBase.EditIn_Prikaz_Perevod(editElem);
                    break;
            }
        ...
        public override void Refresh()
        {
            ...
            Data = new List<In_Prikaz_Perevod>(DataBase.DataBase.GetIn_Prikaz_Perevod());
        }
        ...
        public override void Delete()
        {
            ...
            {
                In_Prikaz_Perevod item = collectionView.CurrentItem as In_Prikaz_Perevod;
                if (item != null)
                    DataBase.DataBase.DeleteIn_Prikaz_Perevod(item);
            }
            Refresh();
        }
        ...
        {
            EditingElem = new In_Prikaz_Perevod();
        ...
        public override void Edit()
        {
            ...
            if (collectionView != null)
            {
                ...
                if (item != null)
                {
                    PodrColl = DataBase.DataBase.GetSpr_Struct_Podr();
                    Sotrs = DataBase.DataBase.GetSpr_Sotr();
                    EditingElem = item.Copy() as In_Prikaz_Perevod;
