...
{
    public class In_Prikaz_UvolViewModel : DocumentViewModel
    {
        #region Private fields
        private List<In_Prikaz_Uvol> _data;
        ...
        #region In_Prikaz_Uvol binding fields
        private In_Prikaz_Uvol _editingElem;

        public In_Prikaz_Uvol EditingElem
        {
        ...
        #region Constructors
        public In_Prikaz_UvolViewModel(string docName, MainWindowViewModel mainModelView)
        ...
        public List<In_Prikaz_Uvol> Data
        {
            get
            {
                if (_data == null)
                    _data = new List<In_Prikaz_Uvol>();
                return _data;
            }
            private set
            {
        ...
        public void AddApprove()
        {
            switch (_opType)
            {
                case OperationType.Add:
                    In_Prikaz_Uvol addElem = EditingElem.Copy() as In_Prikaz_Uvol; 
                    DataBase.DataBase.AddIn_Prikaz_Uvol(addElem);
                    break;
                case OperationType.Edit:
                    In_Prikaz_Uvol editElem = EditingElem.Copy() as In_Prikaz_Uvol;
                    DataBase.DataBase.EditIn_Prikaz_Uvol(editElem);
                    break;
            }
        ...
        public override void Refresh()
        {
            ...
            Data = new List<In_Prikaz_Uvol>(DataBase.DataBase.GetIn_Prikaz_Uvol());
        }
        ...
        public override void Delete()
        {
            ...
            {
                In_Prikaz_Uvol item = collectionView.CurrentItem as In_Prikaz_Uvol;
                if (item != null)
                    DataBase.DataBase.DeleteIn_Prikaz_Uvol(item);
            }
            Refresh();
        }
        ...
        {
            EditingElem = new In_Prikaz_Uvol();
        ...
        public override void Edit()
        {
            ...
            if (collectionView != null)
            {
                ...
                {
                    Sotrs = DataBase.DataBase.GetSpr_Sotr();
                    EditingElem = item.Copy() as In_Prikaz_Uvol;
