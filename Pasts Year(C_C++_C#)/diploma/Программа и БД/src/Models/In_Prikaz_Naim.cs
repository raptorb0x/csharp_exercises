...
{
    public class In_Prikaz_Naim : BaseModel
    {
        ...
        public override BaseModel Copy()
        {
            ...
            return new In_Prikaz_Naim() { Sotr = newSotr, Id = this.Id, OldPodr = newOldPodr, PrType = this.PrType, Prichina = this.Prichina, DatePr = this.DatePr };
        }
