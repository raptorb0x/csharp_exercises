...
**
** Created: Mon 24. May 08:54:43 2010
...
static const uint qt_meta_data_TDPreviewDialog[] = {
 ...
 // enum data: key, value
     202, uint(TDPreviewDialog::NoGrid),
     209, uint(TDPreviewDialog::NormalGrid),
     220, uint(TDPreviewDialog::AlternateColor),
     235, uint(TDPreviewDialog::AlternateWithGrid),
...
static const char qt_meta_stringdata_TDPreviewDialog[] = {
    ...
    "on_pageSpinBox_valueChanged(int)\0"
    "on_okPushButton_clicked()\0"
    "on_pushButton_clicked()\0Grids\0NoGrid\0"
    "NormalGrid\0AlternateColor\0AlternateWithGrid\0"
};
...
int TDPreviewDialog::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: on_okPushButton_clicked(); break;
