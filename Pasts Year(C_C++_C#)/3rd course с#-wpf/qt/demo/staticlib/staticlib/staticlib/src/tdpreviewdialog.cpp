...
TDPreviewDialog::TDPreviewDialog(QTableView *p_tableView, QPrinter * p_printer, QWidget *parent) : QDialog(parent)
{
        ...
        setHeaderText(QString::fromLocal8Bit("Документ"));
        footerText=QString::fromLocal8Bit("Страница: ");
...
void TDPreviewDialog::on_okPushButton_clicked()
{
    print();
}
void TDPreviewDialog::on_pushButton_clicked()
{
   exportPdf("test.pdf");
}
//=================================================================
