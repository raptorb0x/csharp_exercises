...
// $Id: pdflib.hpp,v 1.80.2.1 2010/01/15 11:03:56 stm Exp $
//
...
#ifdef PDFCPP_USE_CPP_TRY_CATCH
/*
 * This works only for .NET, where the PDFlib core library is also compiled
 * as C++!
 */
namespace
{
...
public:
            ...
            m_PDFlib_api(::PDF_get_api())
    {
        ...
        {
            /*
             * Cannot throw a basic_PDFlib::Exception here, as in case of
             * out-of-memory it will probably not be possible to allocate the
             * member strings of the Exception object.
             */
            throw std::bad_alloc();
        }
        ...
        PDFCPP_TRY
        {
            ...
            {
                PDF_set_parameter(p, "binding", "C++ conv");
            ...
            else
            {
                ...
                {
                case sizeof(char):
                    PDF_set_parameter(p, "binding", "C++ legacy");
                    break;

                case utf16_wchar_t_size:
                    PDF_set_parameter(p, "apitextformat", "utf16");
                    PDF_set_parameter(p, "binding", "C++");
                    set_unicaplang_parameters();
                    break;

                case utf32_wchar_t_size:
                    PDF_set_parameter(p, "apitextformat", "utf32");
                    PDF_set_parameter(p, "binding", "C++");
                    set_unicaplang_parameters();
                    break;
