...
{
    public class In_Svid_Pov_KvViewModel : DocumentViewModel
    {
        #region Private fields
        private List<In_Svid_Pov_Kv> _data;
        private List<Out_An_Tek> _sotrs;
        ...
        #region In_Svid_Pov_Kv binding fields
        private In_Svid_Pov_Kv _editingElem;

        public In_Svid_Pov_Kv EditingElem
        {
        ...
        #region Constructors
        public In_Svid_Pov_KvViewModel(string docName, MainWindowViewModel mainModelView)
        ...
        public List<In_Svid_Pov_Kv> Data
        {
            get
            {
                if (_data == null)
                    _data = new List<In_Svid_Pov_Kv>();
                return _data;
            }
            private set
            {
        ...
        public List<Out_An_Tek> Sotrs
        {
            get
            {
                if (_sotrs == null)
                    _sotrs = new List<Out_An_Tek>();
                return _sotrs;
            }
            private set
            {
        ...
        public void AddApprove()
        {
            switch (_opType)
            {
                case OperationType.Add:
                    In_Svid_Pov_Kv addElem = EditingElem.Copy() as In_Svid_Pov_Kv; 
                    DataBase.DataBase.AddIn_Svid_Pov_Kv(addElem);
                    break;
                case OperationType.Edit:
                    In_Svid_Pov_Kv editElem = EditingElem.Copy() as In_Svid_Pov_Kv;
                    DataBase.DataBase.EditIn_Svid_Pov_Kv(editElem);
                    break;
            }
        ...
        {
            return EditingElem != null && EditingElem.FactDate != null;
        }
        ...
        public override void Refresh()
        {
            ...
            Data = new List<In_Svid_Pov_Kv>(DataBase.DataBase.GetIn_Svid_Pov_Kv());
        }
        ...
        public override void Delete()
        {
            ...
            {
                In_Svid_Pov_Kv item = collectionView.CurrentItem as In_Svid_Pov_Kv;
                if (item != null)
                    DataBase.DataBase.DeleteIn_Svid_Pov_Kv(item);
            }
            Refresh();
        }
        ...
        {
            EditingElem = new In_Svid_Pov_Kv();
            Sotrs = DataBase.DataBase.GetOut_An_Tek();
        ...
        public override void Edit()
        {
            ...
            if (collectionView != null)
            {
                ...
                {
                    Sotrs = DataBase.DataBase.GetOut_An_Tek();
                    EditingElem = item.Copy() as In_Svid_Pov_Kv;
