...
{
    public partial class SPRorUP : Form
    {
        public SPRorUP()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            HO = orawork.Load("SELECT CODEOBJ FROM SPR_FOND WHERE ADRESS='" + comboBox1.SelectedItem.ToString() + "'");
            ...
            this.queriesTableAdapter1.SPRORABUP(Convert.ToDecimal(textBox1.Text),
