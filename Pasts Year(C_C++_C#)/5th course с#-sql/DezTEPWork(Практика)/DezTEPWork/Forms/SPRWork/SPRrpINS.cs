...
{
    public partial class SPRrpINS : Form
    {
        public SPRrpINS()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
           ...
           this.spR_POSLEDTableAdapter1.INSERT(Convert.ToDecimal(textBox1.Text), Convert.ToDecimal(Wrok), Convert.ToDecimal(textBox3.Text));
            this.Close();
        }
